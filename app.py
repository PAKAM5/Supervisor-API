...
def webhook():
    ...
    try:
        ...
        #Add new school to database
            ...
            msg.body = 'Hi ' + first_namew + ' ' + last_namew + ', your account has been created in the BetterBoardingToolkit App. Your account school id is ' + str(school.id) + ' and your password is ' + str(random_password) + 'Please login to your account on the app using the details you have just inputted to continue'
            mail.send(msg)
